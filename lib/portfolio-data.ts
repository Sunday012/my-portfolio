...
export const musicPicks = [
  {
    title: "Give Thanks",
    artist: "Don Moen",
    year: "worship classic",
    note: "Simple, steady worship. The kind of song that slows everything down and brings gratitude back into focus.",
  },
  {
    title: "Thank You Lord",
    artist: "Don Moen",
    year: "worship classic",
    note: "A direct gratitude song. It has that old worship simplicity that still works because it does not try too hard.",
  },
  {
    title: "Counting My Blessings",
    artist: "Seph Schlueter",
    year: "2023",
    note: "Bright, thankful, and easy to keep on repeat. It feels like taking inventory of grace instead of complaints.",
  },
  {
    title: "Gratitude",
    artist: "Brandon Lake",
    year: "2020",
    note: "Honest worship for when words feel small. I like how it lets thankfulness sound both quiet and big.",
  },
  {
    title: "What a Beautiful Name",
    artist: "Hillsong Worship",
    year: "2016",
    note: "A clean, Jesus-centered worship song with a strong melody and a chorus that feels built for a room singing together.",
  },
  {
    title: "His Name Is Jesus",
    artist: "Phil Wickham",
    year: "2022",
    note: "Clear, worshipful, and centered on Jesus without needing too much decoration around it.",
  },
  {
    title: "Daylight",
    artist: "David Kushner",
    year: "2023",
    note: "Not a worship song in the same lane, but I like the tension in it: confession, darkness, longing, and a heavy atmosphere.",
  },
  {
    title: "Good Day",
    artist: "Forrest Frank",
    year: "2024",
    note: "Light, hopeful, and joyful. Forrest Frank has that faith-filled sound that can lift a normal day without feeling forced.",
  },
  {
    title: "No Longer Bound",
    artist: "Forrest Frank and Hulvey",
    year: "2023",
    note: "Faith, freedom, and bounce in one song. It feels encouraging without losing its groove.",
  },
  {
    title: "Mike Malagies",
    artist: "faith-forward listening",
    year: "current rotation",
    note: "One of the newer voices I would keep in the rotation for reflective, faith-shaped listening.",
  },
];
